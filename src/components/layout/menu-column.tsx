...
export function MenuColumn({
  ...
  const customInnerWidthClassName = customContent
    ? "w-[248px]"
    : "w-[calc(var(--app-shell-nav-compact-width)+24px)] min-[1296px]:w-[calc(var(--app-shell-nav-width)+24px)]";
  const customRailWidthClassName = customContent
    ? "w-[224px] min-w-[224px]"
    : "w-[var(--app-shell-nav-compact-width)] min-w-[var(--app-shell-nav-compact-width)] min-[1296px]:w-[var(--app-shell-nav-width)] min-[1296px]:min-w-[var(--app-shell-nav-width)]";
  ...
  return (
    ...
    >
      <div
        ...
        className={`flex min-w-0 min-[721px]:h-full ${customInnerWidthClassName} items-stretch justify-end pl-2 pr-4 transition-[width] duration-200 ease-out`.trim()}
      >
        <aside
          className={`relative z-10 min-[721px]:h-full ${customRailWidthClassName} ${
        ...
        >
          {customContent ? (
            <div
              ...
              className={`flex min-[721px]:h-full ${customRailWidthClassName} flex-col items-stretch overflow-hidden px-0 pb-4 pt-[92px]`.trim()}
            >
              {customContent}
            </div>
          ) : (
